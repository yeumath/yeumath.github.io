...
a) Tính giao hoán(Commutative law): $$a + b = b + a với mọi a, b in \Bbb R$$
b) Tính kết hợp(Associative law): $$(a + b) + c = a + (b + c) với mọi a, b, c in \Bbb R$$
c) Phần tử đơn vị(Additive identity): Tồn tại một số thực duy nhất, kí hiệu là 0 thỏa mãn tính chất: $$a + 0 = 0 + a = a với mọi số a in \Bbb R$$
