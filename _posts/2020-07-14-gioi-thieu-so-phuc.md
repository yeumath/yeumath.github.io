...
## 2. Biểu diễn số phức:
Để biểu diễn cho $$\sqrt{-1}$$ ta dùng kí hiệu $$i$$. Vì vậy số phức là những số có dạng $$x = a + bi$$ với $$a, b$$ là các số thực, a được gọi là phần thực kí hiệu là $$\Re z$$, b được gọi là phần ảo kí hiệu là $$\Im z$$. Khi b = 0 thì z là số thực, khi a = 0 thì z = bi được gọi là số thuần ảo. Tập hợp các số phức được kí hiệu là $$\Bbb C$$.
